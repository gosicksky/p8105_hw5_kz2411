...
The raw data has `r nrow(homicide_data_raw)` observations. There are `r ncol(homicide_data_raw)` variables, and they are `r colnames(homicide_data_raw)`. Their types are numeric and character.
